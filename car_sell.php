...
<head>
    ...
    <!-- Template Stylesheet -->
    <link href="css/car_sell.css" rel="stylesheet">
</head>
...
<div class="container-fluid page-header">
    <h1 class="display-3 text-uppercase text-white mb-3">Welcome to Car Sell</h1>
    ...
    <div class="col-md-9">
        ...
        <div class="row" id="carListings">
            ...
            <div class="col-md-4 mb-4 car-item" data-price="1800" data-brand="Audi" data-seating="5" data-type="Sedan">
                <div class="card h-100">
                    <div class="image-container">
                        <img src="img/car sell_2.png" class="card-img-top" alt="Audi A3">
                    </div>
                    <div class="card-body">
                        ...
                        <ul class="car-details">
                            ...
                            <li><strong>Transmission:</strong> Automatic</li>
                            <li><strong>Mileage:</strong> 18.0 kmpl</li>
            ...
            <div class="col-md-4 mb-4 car-item" data-price="1600" data-brand="Honda" data-seating="5" data-type="Sedan">
                <div class="card h-100">
                    <div class="image-container">
                        <img src="img/car sell_4.png" class="card-img-top" alt="Honda City">
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-4 mb-4 car-item" data-price="2200" data-brand="Mercedes" data-seating="4" data-type="Convertible">
                <div class="card h-100">
                    <div class="image-container">
                        <img src="img/car-rent-6.png" class="card-img-top" alt="Mercedes S-Class">
                    </div>
                    <div class="card-body">
                        ...
                        <ul class="car-details">
                            ...
                            <li><strong>Fuel Type:</strong> Petrol</li>
                            <li><strong>Transmission:</strong> Automatic</li>
                            <li><strong>Mileage:</strong> 15.0 kmpl</li>
                            <li><strong>Year:</strong> 2021</li>
                        </ul>
                        <a href="sell_booking.html" class="btn btn-custom w-100">Book Now</a>
                    </div>
            ...
            <div class="col-md-4 mb-4 car-item" data-price="1800" data-brand="Hyundai" data-seating="5" data-type="SUV">
                <div class="card h-100">
                    <div class="image-container">
                        <img src="img/car sell_7.png" class="card-img-top" alt="Hyundai Creta">
                    </div>
                    <div class="card-body">
                        ...
                        <ul class="car-details">
                            ...
                            <li><strong>Fuel Type:</strong> Diesel</li>
                            <li><strong>Transmission:</strong> Automatic</li>
                            <li><strong>Mileage:</strong> 21.4 kmpl</li>
                            <li><strong>Year:</strong> 2021</li>
                        </ul>
                        <a href="sell_booking.html" class="btn btn-custom w-100">Book Now</a>
                    </div>
            ...
            <div class="col-md-4 mb-4 car-item" data-price="1500" data-brand="Ford" data-seating="5" data-type="SUV">
                <div class="card h-100">
                    <div class="image-container">
                        <img src="img/car sell_6.png" class="card-img-top" alt="Ford EcoSport">
                    </div>
                    <div class="card-body">
                        ...
                        <ul class="car-details">
                            ...
                            <li><strong>Fuel Type:</strong> Diesel</li>
                            <li><strong>Transmission:</strong> Manual</li>
                            <li><strong>Mileage:</strong> 21.7 kmpl</li>
                            <li><strong>Year:</strong> 2020</li>
                        </ul>
                        <a href="sell_booking.html" class="btn btn-custom w-100">Book Now</a>
                    </div>
            ...
            <div class="col-md-4 mb-4 car-item" data-price="1900" data-brand="Toyota" data-seating="7" data-type="MUV">
                <div class="card h-100">
                    <div class="image-container">
                        <img src="img/car sell_5.png" class="card-img-top" alt="Toyota Innova">
                    </div>
                    <div class="card-body">
                        ...
                        <ul class="car-details">
                            ...
                            <li><strong>Fuel Type:</strong> Diesel</li>
                            <li><strong>Transmission:</strong> Automatic</li>
                            <li><strong>Mileage:</strong> 16.0 kmpl</li>
                            <li><strong>Year:</strong> 2020</li>
                        </ul>
                        <a href="sell_booking.html" class="btn btn-custom w-100">Book Now</a>
                    </div>
            ...
            <div class="col-md-4 mb-4 car-item" data-price="1700" data-brand="Kia" data-seating="7" data-type="SUV">
                <div class="card h-100">
                    <div class="image-container">
                        <img src="img/car sell_4.png" class="card-img-top" alt="Kia Seltos">
                    </div>
                    <div class="card-body">
                        ...
                        <ul class="car-details">
                            ...
                            <li><strong>Fuel Type:</strong> Petrol</li>
                            <li><strong>Transmission:</strong> Automatic</li>
                            <li><strong>Mileage:</strong> 16.5 kmpl</li>
                            <li><strong>Year:</strong> 2020</li>
                        </ul>
                        <a href="sell_booking.html" class="btn btn-custom w-100">Book Now</a>
                    </div>
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="car-details">
                            ...
                            <li><strong>Fuel Type:</strong> Petrol</li>
                            <li><strong>Transmission:</strong> Automatic</li>
                            <li><strong>Mileage:</strong> 14.0 kmpl</li>
                            <li><strong>Year:</strong> 2020</li>
                        </ul>
                        <a href="sell_booking.html" class="btn btn-custom w-100">Book Now</a>
                    </div>
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="car-details">
                            ...
                            <li><strong>Fuel Type:</strong> Diesel</li>
                            <li><strong>Transmission:</strong> Automatic</li>
                            <li><strong>Mileage:</strong> 15.3 kmpl</li>
                            <li><strong>Year:</strong> 2021</li>
                        </ul>
                        <a href="sell_booking.html" class="btn btn-custom w-100">Book Now</a>
                    </div>
            ...
            <div class="col-md-4 mb-4 car-item" data-price="1600" data-brand="Skoda" data-seating="5" data-type="Sedan">
                <div class="card h-100">
                    <div class="image-container">
                        <img src="img/car-sell_1.png" class="card-img-top" alt="Skoda Octavia">
                    </div>
                    <div class="card-body">
     ...
     <div class="faq-container">
        ...
        <div class="faq-item">
            <div class="faq-question" onclick="toggleAnswer(this)">
                What happens if I receive multiple offers for my vehicle?
                <span class="icon">+</span>
            </div>
            <div class="faq-answer">
                <p>Sellers have the option to review and consider multiple offers from different buyers before making a decision. They can negotiate terms individually with each buyer to find the best deal.</p>
            </div>
        </div>
        ...
        <div class="faq-item">
            ...
            <div class="faq-answer">
                <p>The time it takes to sell a car can vary depending on market demand, pricing, and other factors. On average, it may take a few days to a few weeks.</p>
            </div>
        </div>
    
        <div class="faq-item">
            <div class="faq-question" onclick="toggleAnswer(this)">
                What happens if my vehicle doesn’t sell within a certain timeframe?
                <span class="icon">+</span>
            </div>
            <div class="faq-answer">
                <p>If your vehicle doesn’t sell within the expected timeframe, you can reassess your listing, adjust the price, or consider different marketing strategies to attract more buyers.</p>
            </div>
        </div>
    
        <div class="faq-item">
            <div class="faq-question" onclick="toggleAnswer(this)">
                Who will be responsible for RC transfer?
                <span class="icon">+</span>
            </div>
            <div class="faq-answer">
                <p>The responsibility for the RC (Registration Certificate) transfer usually lies with the seller, though in some cases the buyer may assist. It’s essential to complete the RC transfer to officially transfer ownership of the vehicle.</p>
            </div>
        </div>
        ...
        <div class="faq-item">
            ...
            <div class="faq-answer">
                <p>Accepted payment methods typically include bank transfers, online payments, and certified checks. Cash payments may also be accepted, but it is recommended to keep records of all transactions for security purposes.</p>
            </div>
        </div>
    
        <div class="faq-item">
            <div class="faq-question" onclick="toggleAnswer(this)">
                Are there any restrictions on pricing my vehicle?
                <span class="icon">+</span>
            </div>
            <div class="faq-answer">
                <p>There are no strict restrictions on how you price your vehicle, but it’s advisable to research market prices for similar vehicles to set a competitive and fair price.</p>
            </div>
        </div>
        ...
        <div class="faq-item">
            ...
            <div class="faq-answer">
                <p>To determine if a buyer is genuine, look for clear communication, ask for identification, and request that payment be made through secure and traceable methods. Avoid any suspicious or high-pressure situations.</p>
            </div>
        </div>
    
        <div class="faq-item">
            <div class="faq-question" onclick="toggleAnswer(this)">
                What if I change my mind about selling my car?
                <span class="icon">+</span>
            </div>
            <div class="faq-answer">
                <p>If you change your mind about selling your car, you can simply remove the listing or inform any potential buyers that you are no longer selling. Be sure to do this before signing any agreements or accepting payments.</p>
            </div>
        </div>
        ...
        <div class="faq-item">
            ...
            <div class="faq-answer">
                <p>Yes, you can remove your listing at any time. Most platforms allow you to delete or deactivate your car listing from your account dashboard or through customer support.</p>
            </div>
        </div>
    </div>
