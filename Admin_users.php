...
$sql = "SELECT id, username, email, password, image, created_at, last_login FROM admin_login"; 
...
<section class="home-section">
  <nav>
    <div class="sidebar-button">
      <i class='bx bx-menu'></i><span class="dashboard">Users</span>
    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if (!empty($admin['image'])): ?>
                                            <img src="<?php echo htmlspecialchars($admin['image']); ?>" alt="Admin Image" style="width: 50px; height: 50px; border-radius: 50%;">
                                        <?php else: ?>
                                            No Image
                                        <?php endif; ?>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <a href="delete_admin.php?id=<?php echo $admin['id']; ?>" onclick="return confirm('Are you sure you want to delete this admin?');">
